...
module.exports = {
    ...
    render: function(templateStrOrFncOrParser, model){
        return this.compile(templateStrOrFncOrParser)(model);
    },
...
var isolatedVars = 'var Promise,Generator,GeneratorFunction,Function,Buffer,ArrayBuffer,Reflect,Proxy,eval;'
// Nodejs eval and async global objects
isolatedVars += 'var setTimeout,clearTimeout,setInterval,clearInterval,setImmediate,clearImmediate,global,GLOBAL,require,process,__dirname,__filename,console,exports,module;';
...
function countOfHtmlTag(position, str, elemCounts){
    ...
    if(elemCounts['!--'] && !end.count) return elemCounts['!--'];
...
function parse(str){
    ...
    while(parser.position < len){
        //console.warn(str[parser.position], lastCodeType, parser.mode, parser.parentMode, curlyOpens, curlyCloses, parser.parentBrackets);
